...
export class NoteUpdateManyWithoutUserNestedInput {
    ...
    set?: Array<Prisma.AtLeast<NoteWhereUniqueInput, 'id'>>;

    @Field(() => [NoteWhereUniqueInput], {nullable:true})
    @Type(() => NoteWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<NoteWhereUniqueInput, 'id'>>;

    @Field(() => [NoteWhereUniqueInput], {nullable:true})
    @Type(() => NoteWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<NoteWhereUniqueInput, 'id'>>;

    @Field(() => [NoteWhereUniqueInput], {nullable:true})
    @Type(() => NoteWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<NoteWhereUniqueInput, 'id'>>;
